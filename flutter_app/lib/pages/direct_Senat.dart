...
class PageDirectSenat extends StatefulWidget {
  @override
  _PageDirectSenatState createState() => _PageDirectSenatState();
}

class _PageDirectSenatState extends State<PageDirectSenat> {
  bool selected = true;
